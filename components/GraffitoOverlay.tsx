      ...
      <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-2000">
        <div className="bg-white rounded-lg w-11/12 h-4/5 overflow-y-auto p-4 relative text-black">
          <div className="bg-gray-200 bg-opacity-50 sticky top-0 p-4 z-10 flex justify-between items-center rounded-lg">
            <h1 className="text-2xl font-bold mb-0 inline-block">Graffito: {graffito.title}</h1>
              <button 
                onClick={onClose} 
          ...
          <div className="flex">
            <div className='text-black flex-1'>  
              <p><strong>Description:</strong> {graffito.description}</p>
              <p><strong>Graffito Type:</strong> {graffito.types}</p>
              <p><strong>Start Date of Visibilty:</strong> {graffito.startDate}</p>
              <p><strong>End Date of Visibilty:</strong> {graffito.endDate}</p>
              <p><strong>Colors used:</strong> {graffito.colors}</p>
              <p><strong>Area covered:</strong> {graffito.area}</p>
